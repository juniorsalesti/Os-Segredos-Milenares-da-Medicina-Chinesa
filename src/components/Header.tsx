      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 py-2.5 flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          >
            ...
            <span className="hidden md:inline text-xs sm:text-sm text-[#1F2937] dark:text-[#EAE3DC]">Buscar...</span>
          </button>
        </div>
        ...
        <div className="flex items-center gap-1.5 sm:gap-3">
          ...
          <div className="text-center">
            <h1 className="font-serif font-bold text-xs sm:text-sm tracking-tight line-clamp-1 max-w-[150px] sm:max-w-xs md:max-w-md">
              Os Segredos Milenares da Medicina Chinesa
            </h1>
            <p className="text-[11px] font-serif font-semibold opacity-90">
              Página <span className="font-bold text-[#8C3A2B] text-xs">{currentPageIndex + 1}</span> de {totalPages}
            </p>
          </div>
        ...
        <div className="flex items-center gap-1.5 sm:gap-2">
          ...
          <button
            ...
            title={isPlayingAudio ? "Pausar Música de Fundo" : "Ouvir Música Relaxante (Guqin & Água)"}
          >
          ...
          <div className="flex sm:hidden items-center gap-1">
            <button
              ...
              title="Alternar Tema (Papel, Sépia, Noite)"
            >
              {theme === 'paper' && <Sun className="w-4 h-4 text-amber-700" />}
              {theme === 'sepia' && <span className="font-bold text-amber-900 text-xs">Sépia</span>}
          ...
          <button
            ...
            title="Imprimir ou Salvar Livro em PDF"
          >
