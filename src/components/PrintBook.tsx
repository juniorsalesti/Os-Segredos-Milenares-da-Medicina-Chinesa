  ...
  return (
    <div className="hidden print:block text-black bg-white p-8 space-y-12 font-serif">
      ...
      <div className="page-break pt-8 space-y-8">
        <h2 className="text-3xl font-bold border-b-2 border-amber-900 pb-2">As 100 Receitas Tradicionais</h2>
        {ALL_RECIPES.map((r) => (
          <div key={r.id} className="border p-6 rounded-lg space-y-4 my-6 page-break-inside-avoid bg-gray-50">
            <div className="border-b pb-2">
              ...
              <h3 className="text-xl font-bold text-gray-900">Receita #{r.id}: {r.title}</h3>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 text-xs">
              <div>
                <h4 className="font-bold border-b pb-1 mb-2 text-amber-900">Ingredientes:</h4>
              ...
              <div>
                <h4 className="font-bold border-b pb-1 mb-2 text-amber-900">Modo de Preparo:</h4>
            ...
            <div className="text-xs space-y-2 pt-2 border-t">
              <p><strong>Como Consumir:</strong> {r.comoConsumir}</p>
              <p><strong>Cuidados:</strong> {r.cuidados}</p>
              <p><strong>Curiosidade:</strong> {r.curiosidade}</p>
              <p className="italic text-amber-900"><strong>Dica da Mestra Lin:</strong> "{r.dicaMestraLin}"</p>
            </div>
          </div>
        ))}
      </div>
